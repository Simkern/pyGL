...
def G_ForwardMap(UA, SA, Q, tau):
    ...
    K0 = UA @ SA
    sol = solve_ivp(Kdot, (0,tau), K0.flatten(), args=(Q, UA), first_step=tau)
    ...
    sol = solve_ivp(Sdot, (0,tau), Sh.flatten(), args=(Q, U1, UA), first_step=tau)
    St = sol.y[:,-1].reshape((r,r))
    
    # solve Ldot = U1.T @ Q
    L0 = St @ UA.T
    sol = solve_ivp(Ldot, (0,tau), L0.flatten(), args=(Q, U1), first_step=tau)   
